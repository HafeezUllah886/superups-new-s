            ...
            $.ajax({
                ...
                success: function(product) {
                    ...
                    if (found.length > 0) {
                        ...
                        html += '<td class="no-padding"><input type="number" name="qty[]" oninput="updateChanges(' + id +')" min="0.1"  step="any" value="1" class="form-control text-center" id="qty_' + id + '"></div></td>';
